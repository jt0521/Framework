...
public class DataPicker {
    ...
    public static void setTextPickerStyle(Context context, Object picker) {
        if (picker instanceof DateWheelPicker) {
            ...
            ((DateWheelPicker) picker).setTextColor(context.getResources().getColor(R.color.c_dialog_content_text));
            ...
            ((DateWheelPicker) picker).setLineColor(context.getResources().getColor(R.color.c_dialog_line));
            ...
            ((MultipleTextWheelPicker) picker).setTextColor(context.getResources().getColor(R.color.c_dialog_content_text));
            ...
            ((MultipleTextWheelPicker) picker).setLineColor(context.getResources().getColor(R.color.c_dialog_line));
        } else if (picker instanceof FutureTimePicker) {
            ((FutureTimePicker) picker).setBackgroundDrawable(new ColorDrawable(Color.WHITE));
            ((FutureTimePicker) picker).setTextColor(context.getResources().getColor(R.color.c_dialog_content_text));
            ...
            ((FutureTimePicker) picker).setLineColor(context.getResources().getColor(R.color.c_dialog_line));
        } else if (picker instanceof TextWheelPicker) {
            ((TextWheelPicker) picker).setBackgroundDrawable(new ColorDrawable(Color.WHITE));
            ((TextWheelPicker) picker).setTextColor(context.getResources().getColor(R.color.c_dialog_content_text));
            ...
            ((TextWheelPicker) picker).setLineColor(context.getResources().getColor(R.color.c_dialog_line));
        }
    }
