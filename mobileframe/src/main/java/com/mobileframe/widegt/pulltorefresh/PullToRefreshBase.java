...
import com.mobileframe.tools.DeviceUtils;
...
public abstract class PullToRefreshBase<T extends View> extends LinearLayout
     ...
     * 是否在向上拉动时调用刷新
     */
    protected boolean mPullingRefresh = true;
    ...
    public void setPullingRefresh(boolean pullingRefresh) {
        mPullingRefresh = pullingRefresh;
    }
...
//				}
    ...
    protected void onPullToRefresh() {
        switch (mCurrentMode) {
            case PULL_FROM_END:
                ...
                if (mOnRefreshListener2 != null && mPullingRefresh) {
    ...
    protected final void setHeaderScroll(int value) {
        ...
        if (USE_HW_LAYERS && DeviceUtils.getSystemVersionLevel() > 10) {
            /**
