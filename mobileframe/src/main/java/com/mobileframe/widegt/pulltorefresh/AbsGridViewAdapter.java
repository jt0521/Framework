...
//		}
    ...
    protected RequestListener getListener() {
        return new RequestListener<ResultBean<List<B>>>() {

            @Override
            public void onSuccess(ResultBean<List<B>> response) {
                mCurrentPage++;
                mRequestId = null;
                List<B> json = response.body;
            ...
            public boolean onFailure(int code, String msg, boolean netError) {
                ...
                AbsGridViewAdapter.this.onFailure(code, msg);
                return super.onFailure(code, msg, netError);
            }
        };
    }
        ...
        switch (mCurrentState) {
            ...
            case STATE_SINGLE_EMPTY:
                ...
                if (mBeanList == null || mBeanList.size() == 0) {
                    ...
                    ToastUtils.showToast(mContext, R.string.not_data);
                }
                break;
            default:
                break;
