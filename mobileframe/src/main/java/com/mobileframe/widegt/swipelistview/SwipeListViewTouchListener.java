...
package com.mobileframe.widegt.swipelistview;
...
public class SwipeListViewTouchListener implements View.OnTouchListener {
    ...
    public SwipeListViewTouchListener(SwipeListView swipeListView,
        ...
        mRightDeleteWidth = swipeListView.getContext().getResources().getDimension(R.dimen.px140);
    }
...
//								view.setBackgroundResource(R.drawable.white_grey_selector);
                                view.setBackgroundResource(R.color.c_gray);
                            }
                        }
                        resetCell();
                    }
